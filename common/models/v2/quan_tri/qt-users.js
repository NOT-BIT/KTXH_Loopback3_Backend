...
module.exports = function (ThisModel) {
  ...
  ThisModel.customCreate = async function (uid, ma, ten, qtDonViId, matKhau,  soDienThoai, email, ghiChu) {
        const queryData = {
            uid: uid,
            ma: ma,
            ten: ten,
  ...
  ThisModel.customUpdate = async function (id, ma, ten, qtDonViId, matKhau, soDienThoai, email, ghiChu, hieuLuc) {
        const queryData = {
            id: id,
            ma: ma,
            ten: ten,
