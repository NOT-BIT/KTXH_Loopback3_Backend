...
module.exports = function (ThisModel) {
  ...
  ThisModel.customCreate = async function (uid, ma, ten, bieuNhapLieuId, donViTongHopCapTinhId, ghiChu) {
    const queryData = {
      uid: uid,
      ma: ma,
      ten: ten,
      bieuNhapLieuId: bieuNhapLieuId,
      donViTongHopCapTinhId: donViTongHopCapTinhId,
      ghiChu: ghiChu,
      createdAt: new Date(),
      createdBy: 0
    }
  ...
  ThisModel.customUpdate = async function (id, ma, ten, bieuNhapLieuId, donViTongHopCapTinhId, ghiChu, hieuLuc) {
    const queryData = {
      id: id,
      ma: ma,
      ten: ten,
  ...
  ThisModel.remoteMethod('customCreate',
    {
      ...
      accepts: [
        ...
        { arg: 'donViTongHopCapTinhId', type: 'number', required: true },
  ...
  ThisModel.remoteMethod('customUpdate',
    {
      ...
      accepts: [
        ...
        { arg: 'donViTongHopCapTinhId', type: 'number' },
        { arg: 'ghiChu', type: 'string' },
