...
module.exports = function (ThisModel) {
  ...
  ThisModel.customCreate = async function (uid, ma, ten, bieuNhapLieuId, donViTongHopId, ghiChu) {
    const queryData = {
      uid: uid,
      ma: ma,
      ten: ten,
      bieuNhapLieuId: bieuNhapLieuId,
      donViTongHopId: donViTongHopId,
      ghiChu: ghiChu,
      createdAt: new Date(),
      createdBy: 0
    }
  ...
  ThisModel.customUpdate = async function (id, ma, ten, bieuNhapLieuId, donViTongHopId, ghiChu, hieuLuc) {
    const queryData = {
      id: id,
      ma: ma,
      ten: ten,
  ...
  ThisModel.remoteMethod('customCreate',
    {
      ...
      accepts: [
        ...
        { arg: 'donViTongHopId', type: 'number', required: true },
  ...
  ThisModel.remoteMethod('customUpdate',
    {
      ...
      accepts: [
        ...
        { arg: 'donViTongHopId', type: 'number' },
        { arg: 'ghiChu', type: 'string' },
